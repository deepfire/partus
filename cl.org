...
* Issues
*** CL Extensions
***** EVAL-IN-LEXENV, ala Scheme
***** Anything, that does not introduce breakage into the Quicklisp world
******* In the same vein: aggressive deprecation
********* symbol properties
*** Technopieces
...
*********** ASSERT
*** Possibilities
***** MAP-CLOSURE :: 2007 Siskind, Pearlmutter - First-class non-standard interpretation by opening closures
