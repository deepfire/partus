...
******* class function
********* created by (into global_variable/function):
*********** compiler_defun
*********** compiler_defmacro
********* used for:
*********** redefiniton checking (in compiler_def*)
*********** for FUNCTION.primitivise, for compile-time availability checking and optional style-warning
******* class fn
********* created by (into function binding (and into globals, if appropriate)):
*********** FUNCTION.primitivise
*********** LABELS.primitivise
*********** FLET.primitivise
********* used by:
*********** find_fn (globals only)
************* depend_on
...
*********** FUNCTION.{binder,rewrite,primitivise)
*********** FLET.{rewrite,primitivise}
******* functions themselves
********* created by machine.execute_bytecode
*********** used by:
************* compile_in_lexenv
*************** macro_function
*************** compile
