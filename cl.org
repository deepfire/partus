...
*** Toplevel names: @DEFUN and @DEFCLASS
...
* Chapter 1: Life
    ...
    We now have symbols, packages, types, semi-proper DEFUN/DEFCLASS
    and the top-level part of dynamic scope.
...
* Chapter 2: Better life (+ dynamic scope)
*** DANGLING CODE
