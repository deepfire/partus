...
********* class clambda_t
*********** storage: lexenv_t
*********** created by (into make_lexenv, rewrite_lambda and primitivise_lambda, for lambda list and nonlocal setqs):
...
************* primitivise_lambda:   lambda list queries, lexenv creation, nonlocal setq query
************* SETQ.primitivise:     nonlocal setq maintenance
************* REFS.primitivise:     nonlocal ref maintenance (OMG, freevar calculation already done?)
